...
export const docs: DocPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: 'A denial is useful', body: `<p>Denied requests return a specific code such as <code>wpcc_token_read_only</code> or <code>wpcc_capability_denied</code>. The latter identifies the missing capability so you can make a deliberate access decision instead of broadening everything.</p>` },
    ],
  },
  {
